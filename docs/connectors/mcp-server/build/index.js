...
server.setRequestHandler(types_js_1.CallToolRequestSchema, async (request) => {
    try {
        ...
        switch (name) {
            ...
            case "create_webhook": {
                if (!args || typeof args.workspace_id !== 'string' || typeof args.resource !== 'string' || typeof args.change_type !== 'string' || typeof args.notification_url !== 'string')
                    throw new Error("workspace_id, resource, change_type, and notification_url required");
            ...
            case "delete_webhook": {
                if (!args || typeof args.workspace_id !== 'string' || typeof args.webhook_id !== 'string')
                    throw new Error("workspace_id and webhook_id required");
