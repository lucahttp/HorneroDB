...
tools: ['vscode', 'execute', 'read', 'agent', 'edit', 'search', 'web', 'sequential-thinking/*', 'chrome-devtools/*', 'todo'] # specify the tools this agent can use. If not set, all enabled tools are allowed.
---
