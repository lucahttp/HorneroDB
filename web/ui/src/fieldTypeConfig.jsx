 ...
 * Each type has: icon (string or React element), label (Spanish), color, and HTML input type.
 */
...
export const FIELD_TYPES = {
  ...
  date: { icon: <Calendar width="1em" height="1em" />, label: 'Fecha', color: '#8b5cf6', inputType: 'date' },
  datetime: { icon: <Clock width="1em" height="1em" />, label: 'Fecha y hora', color: '#8b5cf6', inputType: 'datetime-local' },
  email: { icon: '@', label: 'Email', color: '#ef4444', inputType: 'email' },
  url: { icon: <LinkIcon width="1em" height="1em" />, label: 'URL', color: '#3b82f6', inputType: 'url' },
  ...
  file: { icon: <Attachment width="1em" height="1em" />, label: 'Archivo', color: '#78716c', inputType: 'file' },
}
